# -*- coding: utf-8 -*-
"""
Created on Sat Jun 25 21:53:55 2016

@author: zys
"""
import os
os.chdir("/home/zys/Documents/DataScience/Kaggle/Airbnb/")
...
# fix a bug here (df_all includes a column named 'courntry_destination')
df_train = pd.concat([df_train['country_destination'], df_all.drop('country_destination', axis=1)], axis=1, join='inner')
...
model = grid_search.GridSearchCV(estimator=XGB_model, param_grid=param_grid, scoring='accuracy', verbose=10, n_jobs=3, iid=True, refit=True, cv=5)
...
X_test = df_test.drop(['date_first_booking', 'country_destination'], axis=1, inplace=False)
